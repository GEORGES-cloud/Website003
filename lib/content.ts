...
export const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      'Toallas, refrescos y equipo de snorkel a bordo',
    ...
    featuresEn: [
      ...
      'Beach towels, complimentary soft drinks and snorkelling equipment on board',
...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: 'Uso anual ilimitado, la app de reservas, la preparación profesional del barco antes de cada salida, onboarding y soporte a socios — además de toallas, refrescos y equipo de snorkel a bordo. Sin mantenimiento, seguro ni invernaje que gestionar.',
    aEn: 'Unlimited annual usage, the booking app, professional boat preparation before every trip, onboarding and member support — plus beach towels, complimentary soft drinks and snorkelling equipment on board. No maintenance, insurance or winter storage to think about.',
  },
  {
