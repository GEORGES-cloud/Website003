...
export const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      '¿Sin licencia de navegación? Te orientamos en la dirección correcta',
      'Pregúntanos qué más guarda el Flamingo bajo el ala',
    ],
    featuresEn: [
      ...
      'No boating licence yet? We steer you in the right direction',
      'Ask us what else the Flamingo keeps under its wing',
    ],
    featured: true,
  },
];
...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: 'Uso anual ilimitado, la app de reservas, la preparación profesional del barco antes de cada salida, onboarding y soporte a socios. Sin mantenimiento, seguro ni invernaje que gestionar.',
    aEn: 'Unlimited annual usage, the booking app, professional boat preparation before every trip, onboarding and member support. No maintenance, insurance or winter storage to think about.',
  },
  {
