...
export default function PageHero({ eyebrow, title, subtitle, image }: PageHeroProps) {
  ...
  if (image) {
    return (
      <section className="relative pt-[88px] h-[70vh] min-h-[460px] overflow-hidden">
        ...
        <div className="relative h-full max-w-[1480px] mx-auto px-6 md:px-10 flex flex-col justify-end pb-16">
          <p className="font-sans text-[11px] font-semibold tracking-eyebrow uppercase text-white/85 mb-5">
            {eyebrow}
          </p>
  ...
  return (
    <section className="pt-[136px] pb-16 md:pb-20 bg-bone">
