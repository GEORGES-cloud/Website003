    ...
    >
      ...
      <div className="flex-1 overflow-y-auto flex flex-col px-6 py-12">
        ...
        >
          ...
          {/* Atajo siempre disponible en los pasos previos: hablar ahora
              mismo por WhatsApp (el cierre ya tiene su propio CTA) */}
          {step <= 1 && (
            <a
              ...
              rel="noopener noreferrer"
              onClick={closeFunnel}
              className="inline-flex items-center gap-2 font-sans text-[12px] font-semibold uppercase tracking-wide2 text-sea hover:text-ink transition-colors mt-10"
            >
