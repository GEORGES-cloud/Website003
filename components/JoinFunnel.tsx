        ...
        >
          ...
          {step === 1 && (
            <>
              ...
              <input
                ...
                className="w-full max-w-sm mx-auto block bg-transparent border-b border-line focus:border-flamingo-deep outline-none text-center font-sans text-xl text-ink py-3 mb-10 transition-colors placeholder:text-muted/60"
              />
              <div className="flex flex-col items-center gap-5">
                <button
                  onClick={() => setStep(2)}
                  ...
                  {channel === 'whatsapp' ? (
                    ...
                    >
                      <input
                        ...
                        className="w-full border border-line bg-white px-4 py-2.5 font-sans text-[14px] text-ink placeholder:text-muted/60 focus:outline-none focus:border-flamingo-deep transition-colors"
                      />
          ...
          {step === 1 && (
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={closeFunnel}
              className="inline-flex items-center gap-2 font-sans text-[12px] font-semibold uppercase tracking-wide2 text-flamingo-deep hover:text-ink transition-colors"
            >
