...
export default async function FloatingContact({ locale }: { locale: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[80] flex items-center gap-3 bg-ink text-white pl-4 pr-5 py-3 rounded-full shadow-2xl hover:bg-sea transition-colors duration-300 group"
    >
